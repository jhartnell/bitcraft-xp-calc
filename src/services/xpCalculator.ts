...
export function calculateCraftXp(
  ...
  return {
    ...
    xpInCurrentLevel: currentLevelProgress.xpInCurrentLevel,
    xpSpanForCurrentLevel: currentLevelProgress.levelSpan,
    xpRemainingToNextLevel: currentLevelProgress.xpNeededForNext,
